...
class _SettingPage extends State<SettingPage>
  ...
  void initState() {
    ...
    if (GlobalTheme == GlobalThemeDart) {
      isSwitched = true;
    }
  }
  ...
  Widget websList() {
    ...
    for (WebPortal WEB in Global_webList) {
      webList.add(Container(
          margin: EdgeInsets.only(top: 5, bottom: 5, left: marginRightLeft, right: marginRightLeft),
          height: 50,
                  ...
                  child: Container(
                      ...
                      child: Row(children: <Widget>[
                        ...
                        Container(
                          ...
                          child: Center(
                            child: Text(
                              WEB.url, style: TextStyle(color: GlobalTheme
                                .textColor, fontSize: 18),),
                          ),
                        ),
                        Container(
                          width: 30,
  ...
  Widget signOutGoogle() {
    if (Global_GoogleSign.googleUserIsSignIn() == true) {
      return Center(
          child: Container(
            width: 300,
            margin: EdgeInsets.only(top: 30, bottom: 10, left: marginRightLeft, right: marginRightLeft),
            decoration: new BoxDecoration(
              color: Colors.redAccent,
            ...
            child: FlatButton(
              ...
              child: Row(
                ...
                children: <Widget>[
                  Icon(FontAwesomeIcons.google , color: Color_getColorText(Colors.redAccent)),
                  Container(
                    width: 5,
                  ),
                  Flexible(
                      child: Text(
                        ...
                        style: TextStyle(fontSize: 18 , color: Color_getColorText(Colors.redAccent)),
                      )),
                ],
              ),
            ),
  ...
  Widget label(String textString) {
    return (Container(
      margin: EdgeInsets.only(top: 10, bottom: 10, right: marginRightLeft, left: marginRightLeft),
      ...
      child: Text(
        textString,
        style: TextStyle(fontSize: 20, color: Color_getColorText(GlobalTheme.tabs)),
    ...
    return (
        Container(
          ...
          child: Row(
            ...
            children: <Widget>[
              Text("   Change to darkmode:" , style:TextStyle(color: Color_getColorText(GlobalTheme.tabs) , fontSize: 20)   ),
              Switch(
                value: isSwitched,
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () async {
          bool ischanget =
          await SettingAddPage_ShowDialog(new WebPortal("", ""), this.context);
          setState(() {
            websList();
          });
        },
